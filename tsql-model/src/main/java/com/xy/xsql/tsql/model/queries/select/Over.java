...
public class Over implements Clause {
    ...
    public static class OrderBy {
        ...
        ORDER BY order_by_expression
            ...
            [ ,...n ]
        */
        private List<com.xy.xsql.tsql.model.queries.select.OrderBy.Item> items;

        public List<com.xy.xsql.tsql.model.queries.select.OrderBy.Item> getItems() {
            return items;
        }

        public void setItems(List<com.xy.xsql.tsql.model.queries.select.OrderBy.Item> items) {
            this.items = items;
        }
