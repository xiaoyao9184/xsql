 ...
 */
public class DatetimeOffsetFromParts
    ...
    private Expression hourOffset;
    private Expression minuteOffset;
    ...
    public Expression getHourOffset() {
        return hourOffset;
    }

    public void setHourOffset(Expression hourOffset) {
        this.hourOffset = hourOffset;
    }

    public Expression getMinuteOffset() {
        return minuteOffset;
    }

    public void setMinuteOffset(Expression minuteOffset) {
