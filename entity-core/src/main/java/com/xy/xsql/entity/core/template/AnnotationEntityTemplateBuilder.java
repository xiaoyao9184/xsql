...
public class AnnotationEntityTemplateBuilder implements
    ...
    //config
    private AnnotationEntityTemplateConfig<AnnotationEntityTemplateBuilder> config;
    //cache
     ...
     */
    public AnnotationEntityTemplateConfig<AnnotationEntityTemplateBuilder> configStart() {
        if(this.config == null){
    ...
    @Override
    public AnnotationEntityTemplateBuilder config(AnnotationEntityTemplateConfig config) {
        this.config = config;
        return this;
    }
