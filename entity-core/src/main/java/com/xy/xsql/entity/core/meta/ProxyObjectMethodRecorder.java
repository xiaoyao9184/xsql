 ...
 */
public class ProxyObjectMethodRecorder<T> implements MethodInterceptor {

    private T t;
    private ProxyObjectMethodRecorder<?> currentMock = null;
    ...
    private ProxyObjectMethodRecorder(){

    }

    @SuppressWarnings("unchecked")
    public static <T> ProxyObjectMethodRecorder<T> create(Class<T> cls) {
        Enhancer enhancer = new Enhancer();
        enhancer.setSuperclass(cls);
        final ProxyObjectMethodRecorder recordingObject = new ProxyObjectMethodRecorder();
    ...
    public ProxyObjectMethodRecorder<T> record(Function<T,?> getter) {
        getter.apply(this.getObject());
        return this;
    }
...
//    }
    ...
    public ProxyObjectMethodRecorder<?> getCurrentMock() {
        return currentMock;
    }

    public void setCurrentMock(ProxyObjectMethodRecorder<?> currentMock) {
