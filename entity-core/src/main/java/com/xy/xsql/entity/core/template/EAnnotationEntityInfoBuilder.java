 ...
 */
public class EAnnotationEntityInfoBuilder implements
        ConfigBuilder<
                EAnnotationEntityInfoBuilder,
                AnnotationEntityTemplateConfig,
                Class<?>,
                EntityInfo>,
        Cloneable {
    ...
    //config
    private AnnotationEntityTemplateConfig<EAnnotationEntityInfoBuilder> config;
    //cache
     ...
     *
     */
    public EAnnotationEntityInfoBuilder(){
     ...
     */
    public AnnotationEntityTemplateConfig<EAnnotationEntityInfoBuilder> configStart() {
        if(this.config == null){
    ...
    @Override
    public EAnnotationEntityInfoBuilder config(AnnotationEntityTemplateConfig config) {
        this.config = config;
        return this;
    }
    ...
    @Override
    public EAnnotationEntityInfoBuilder clone(){
        return new EAnnotationEntityInfoBuilder()
