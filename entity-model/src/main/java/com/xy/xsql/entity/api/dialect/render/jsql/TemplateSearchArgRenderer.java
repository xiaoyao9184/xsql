...
public interface TemplateSearchArgRenderer {
     ...
     * @return SQL + 参数
     */
    PlaceholderJSql getSelectJoinByArgsSql(EntityInfo entityData, Object... args);
     ...
     * @return SQL + 参数
     */
    PlaceholderJSql getSelectJoinByTreeArgSql(EntityInfo entityData, EntityTemplateTreeArg entityDataTreeArg);
}
