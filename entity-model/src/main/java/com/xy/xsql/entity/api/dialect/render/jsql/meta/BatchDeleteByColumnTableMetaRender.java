 ...
 */
public interface BatchDeleteByColumnTableMetaRender {

    <C extends EntityColumnMeta,T extends EntityTableMeta<?,C>> PlaceholderJSql rendering(T tableMeta, Collection<C> columnIds, Integer count);
