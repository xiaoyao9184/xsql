...
import static com.xy.xsql.tsql.builder.chain.functions.DataTimeFunctions.f_datetimefromparts;
import static org.junit.Assert.assertEquals;

/**
 * Created by xiaoyao9184 on 2018/6/5.
 */
public class DatetimeFromPartsFunctionTest {


    /**
     * DATETIMEFROMPARTS ( 2010, 12, 31, 23, 59, 59, 0 )
     */
    public DatetimeFromParts example1 = f_datetimefromparts(
            c_number(2010),
            c_number(12),
            c_number(31),
            c_number(23),
    ...
    public void testExample1(){
        ...
        assertEquals(example1.getSeconds().getClass(), NumberConstant.class);
        assertEquals(example1.getMilliseconds().getClass(), NumberConstant.class);
    }
