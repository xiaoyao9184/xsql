...
import com.xy.xsql.tsql.builder.chain.functions.aggregate.StDevFunctionTest;
...
public class StDevConverterTest {
    ...
    private Map<StDev,String> model2StringMap;

    @Before
    public void init(){
        StDevFunctionTest builderTest = new StDevFunctionTest();
