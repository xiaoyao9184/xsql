...
import com.xy.xsql.tsql.builder.chain.functions.aggregate.VarFunctionTest;
 ...
 */
public class VarConverterTest {

    @Test
    public void testMetaPrint() throws Exception {
        BlockMeta b = VarConverter.meta;
    ...
    private Map<Var,String> model2StringMap;

    @Before
    public void init(){
        VarFunctionTest builderTest = new VarFunctionTest();
