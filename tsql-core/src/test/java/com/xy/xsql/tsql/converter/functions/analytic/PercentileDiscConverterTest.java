...
import com.xy.xsql.tsql.builder.chain.functions.analytic.PercentileDiscFunctionTest;
...
public class PercentileDiscConverterTest {
    ...
    private Map<Percentile_Disc,String> model2StringMap;

    @Before
    public void init(){
        PercentileDiscFunctionTest builderTest = new PercentileDiscFunctionTest();
