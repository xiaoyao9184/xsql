...
import com.xy.xsql.tsql.builder.chain.functions.metadata.DbIdFunctionTest;
...
public class DbIdConverterTest {
    ...
    private Map<Db_Id,String> model2StringMap;

    @Before
    public void init(){
        DbIdFunctionTest builderTest = new DbIdFunctionTest();
