...
//                            .then(VariableTableConverter.meta())
                        ...
                        .czse(d -> d instanceof From.BaseTable,BaseTableConverter.meta())
                        .czse(d -> d instanceof From.DerivedTable,DerivedTableConverter.meta())
                        .czse(d -> d instanceof From.JoinedTable,"joined_table")
                            .ref(From.JoinedTable.class)
                            .data(d -> d)
                            .and()
                        .czse(d -> d instanceof From.VariableTable,VariableTableConverter.meta())
//                        .czse(BaseTableConverter.meta())
//                            .filter(d -> d instanceof From.BaseTable)
//                            .and()
//                        .czse(DerivedTableConverter.meta())
...
//                            .data(d -> d)
//                            .and()
//                        .czse(VariableTableConverter.meta())
