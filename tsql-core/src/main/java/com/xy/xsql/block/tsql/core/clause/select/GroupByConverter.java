        ...
        public static BlockMeta meta =
                new BlockMetaBuilder<Void,GroupBy.GroupingSet>()
                        ...
                        .czse(GroupBy.GroupingSet::isUseTotal)
                            ...
                            .keyword("()")
                            .and()
                        .czse(d -> d.getGroupingSetItemList().size() == 1, "grouping_set_item")
                            .description("grouping_set_item")
                            .ref(GroupingSetItemConverter.class)
                            .scope(d -> d.getGroupingSetItemList().get(0))
                            .and()
                        .czse(d -> d.getGroupingSetItemList().size() > 1)
                            .description("( <grouping_set_item> [ ,...n ] )")
                            .sub_keyword(Other.GROUP_START)
                            .sub("grouping_set_item")
                                .list()
                                .ref(GroupingSetItemConverter.class)
                                .scope(GroupBy.GroupingSet::getGroupingSetItemList)
                                .and()
                            .sub_keyword(Other.GROUP_END)
                            .and()
                        .syntax_sub_line()
