 ...
 */
public class AsymKeyPropertyConverter
        implements ModelMetaBlockConverter<AsymKeyProperty> {

    // @formatter:off
    public static BlockMeta meta =
            new BlockMetaBuilder<Void,AsymKeyProperty>()
                    .overall("ASYMKEYPROPERTY")
                    .sub_keyword(Function.Keywords.ASYMKEYPROPERTY)
