 ...
 */
public class ColumnsUpdatedConverter
        implements ModelMetaBlockConverter<Columns_Updated> {

    public static BlockMeta meta = noParam(Function.Keywords.COLUMNS_UPDATED);
