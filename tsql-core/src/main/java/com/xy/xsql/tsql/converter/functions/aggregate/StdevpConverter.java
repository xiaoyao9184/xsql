...
import com.xy.xsql.tsql.model.functions.aggregate.StdDev;
import com.xy.xsql.tsql.model.functions.aggregate.StdDevp;

/**
 * Created by xiaoyao9184 on 2017/6/15.
 */
public class StdevpConverter
        implements ModelMetaBlockConverter<StdDevp> {

    // @formatter:off
    public static BlockMeta meta =
            new BlockMetaBuilder<Void,StdDevp>()
                    .overall("STDEVP")
                    .sub_keyword(Function.Keywords.STDEVP)
