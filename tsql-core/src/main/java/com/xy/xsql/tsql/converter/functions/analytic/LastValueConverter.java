 ...
 */
public class LastValueConverter
        implements ModelMetaBlockConverter<Last_Value> {

    // @formatter:off
    public static BlockMeta meta =
            new BlockMetaBuilder<Void,Last_Value>()
                    .overall("LAST_VALUE")
                    .sub_keyword(Function.Keywords.LAST_VALUE)
