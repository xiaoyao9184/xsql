 ...
 */
public class PercentileContConverter
        implements ModelMetaBlockConverter<Percentile_Cont> {

    // @formatter:off
    public static BlockMeta meta =
            new BlockMetaBuilder<Void,Percentile_Cont>()
                    .overall("PERCENTILE_CONT")
                    .sub_keyword(Function.Keywords.PERCENTILE_CONT)
