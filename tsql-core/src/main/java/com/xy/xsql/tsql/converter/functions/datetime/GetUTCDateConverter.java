...
import com.xy.xsql.tsql.model.functions.datetime.GetUTCDate;
 ...
 */
public class GetUTCDateConverter
        implements ModelMetaBlockConverter<GetUTCDate> {

    public static BlockMeta meta = noParam(Function.Keywords.GETUTCDATE);
