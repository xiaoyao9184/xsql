...
import com.xy.xsql.tsql.model.functions.security.User;
...
public class UserConverter
        implements ModelMetaBlockConverter<User> {

    public static BlockMeta meta = onlyName(Function.Keywords.USER);
