...
public class select_$local_variable {

    static com.xy.xsql.tsql.style.constructor.builder.elements.variables.b_SELECT SELECT(
            String local_variable,
            Expression expression){
        return new com.xy.xsql.tsql.style.constructor.builder.elements.variables.b_SELECT(){
            {
                withItem()
    ...
    //TODO https://docs.microsoft.com/en-us/sql/t-sql/language-elements/declare-cursor-transact-sql?view=sql-server-2017
    static b_SET SET(
            String cursor_variable,
