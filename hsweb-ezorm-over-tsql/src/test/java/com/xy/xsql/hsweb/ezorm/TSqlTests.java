...
import com.xy.xsql.hsweb.ezorm.rdb.render.dialect.TSqlRDBDatabaseMetaData;
...
public class TSqlTests {
    ...
    public void setup() throws Exception {
        ...
        Connection connection = DriverManager
                .getConnection("jdbc:sqlserver://db.xsql.xy.com:1433;DatabaseName=hsweb;integratedSecurity=false"
                        , "xsql", "xsql");
        sqlExecutor = new NoCompileJdbcSqlExecutor() {
            @Override
    ...
    public void testParser() throws Exception {
        RDBDatabaseMetaData databaseMetaData = new TSqlRDBDatabaseMetaData();
